...
// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_attach_statistics__t.xml


%feature("docstring") GENAPI_NAMESPACE::AttachStatistics_t "
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_auto_lock.xml


%feature("docstring") GENAPI_NAMESPACE::AutoLock "
";

%feature("docstring") GENAPI_NAMESPACE::AutoLock::AutoLock "
";

%feature("docstring") GENAPI_NAMESPACE::AutoLock::~AutoLock "
";

// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_c_base_ref_t.xml


%feature("docstring") GENAPI_NAMESPACE::CBaseRefT "
";

%feature("docstring") GENAPI_NAMESPACE::CBaseRefT::GetAccessMode "

Get the access mode of the node.  
";

// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_c_boolean_ref_t.xml


%feature("docstring") GENAPI_NAMESPACE::CBooleanRefT "
";

%feature("docstring") GENAPI_NAMESPACE::CBooleanRefT::SetValue "

Set node value.  
";

%feature("docstring") GENAPI_NAMESPACE::CBooleanRefT::GetValue "
...
%feature("docstring") GENAPI_NAMESPACE::CCategoryRefT "
";

%feature("docstring") GENAPI_NAMESPACE::CCategoryRefT::GetFeatures "

Get all features of the category (including sub-categories).  
";

// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_c_chunk_adapter.xml


%feature("docstring") GENAPI_NAMESPACE::CChunkAdapter "
...
%feature("docstring") GENAPI_NAMESPACE::CChunkAdapter::CheckBufferLayout "
...
%feature("docstring") GENAPI_NAMESPACE::CChunkAdapter::AttachBuffer "
...
%feature("docstring") GENAPI_NAMESPACE::CChunkAdapterDcam "
...
%feature("docstring") GENAPI_NAMESPACE::CChunkAdapterGeneric "
...
%feature("docstring") GENAPI_NAMESPACE::CChunkAdapterGeneric::CChunkAdapterGeneric "
...
%feature("docstring") GENAPI_NAMESPACE::CChunkAdapterGeneric::CheckBufferLayout "
...
%feature("docstring") GENAPI_NAMESPACE::CChunkAdapterGeneric::AttachBuffer "
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_c_chunk_adapter_g_e_v.xml


%feature("docstring") GENAPI_NAMESPACE::CChunkAdapterGEV "
...
%feature("docstring") GENAPI_NAMESPACE::CChunkAdapterGEV::CChunkAdapterGEV "
...
%feature("docstring") GENAPI_NAMESPACE::CChunkAdapterU3V "
...
%feature("docstring") GENAPI_NAMESPACE::CChunkAdapterU3V::CChunkAdapterU3V "
...
%feature("docstring") GENAPI_NAMESPACE::CChunkPort "
...
%feature("docstring") GENAPI_NAMESPACE::CChunkPort::GetAccessMode "
...
%feature("docstring") GENAPI_NAMESPACE::CChunkPort::DetachPort "
...
%feature("docstring") GENAPI_NAMESPACE::CCommandRefT "
";

%feature("docstring") GENAPI_NAMESPACE::CCommandRefT::Execute "

Execute the command.  
";

%feature("docstring") GENAPI_NAMESPACE::CCommandRefT::IsDone "

Query whether the command is executed.  
";

// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_c_enum_entry_ref_t.xml
...
%feature("docstring") GENAPI_NAMESPACE::CEventAdapter "
...
%feature("docstring") GENAPI_NAMESPACE::CEventAdapter1394 "

Distribute the events to the node map.  

C++ includes: EventAdapter1394.h
";
...
%feature("docstring") GENAPI_NAMESPACE::CEventAdapter1394::DeliverEventMessage "
...
%feature("docstring") GENAPI_NAMESPACE::CEventAdapterGeneric "
...
%feature("docstring") GENAPI_NAMESPACE::CEventAdapterGEV "
...
%feature("docstring") GENAPI_NAMESPACE::CEventAdapterGEV::DeliverEventMessage "
...
Delivers the Event + Data listed in the EventData packet (Extended ID flag not
set).  
";
...
%feature("docstring") GENAPI_NAMESPACE::CEventAdapterU3V "
...
%feature("docstring") GENAPI_NAMESPACE::CEventPort "
...
%feature("docstring") GENAPI_NAMESPACE::CEventPort::Write "
...
%feature("docstring") GENAPI_NAMESPACE::CFloatPtr "
...
%feature("docstring") GENAPI_NAMESPACE::CFloatRefT::GetEnumAlias "
...
%feature("docstring") GENAPI_NAMESPACE::CGeneric_XMLLoaderParams "
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_c_integer_ref_t.xml
...
%feature("docstring") GENAPI_NAMESPACE::CLock "
...
%feature("docstring") GENAPI_NAMESPACE::CLock::Lock "
...
%feature("docstring") GENAPI_NAMESPACE::CLockEx "

This class is for testing purposes only. It should not be used for client code
because it exists only for Windows but not for Linux since it uses internal data
structures of a Win32 object  

C++ includes: Synch.h
";

// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_c_node_callback.xml


%feature("docstring") GENAPI_NAMESPACE::CNodeCallback "
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_c_node_map_factory.xml


%feature("docstring") GENAPI_NAMESPACE::CNodeMapFactory "

The node map factory is used for creating node maps from camera description
files.  
...
Creates an empty node map factory for assigning a non-empty node map factory
later.  
";
...
Creates the node map factory and simply stores the full path to the provided
camera description file data.  

Parameters
----------
* `FileType` :  
    Defines how the camera description file is stored, e.g. as zipped XML text.  
* `FileName` :  
    The full path of the camera description file to process.  
* `CacheUsage` :  
    Defines if and how to use the cache for preprocessed camera description
    files.  
* `SuppressStringsOnLoad` :  
    Suppresses loading strings that are not needed for most use cases, e.g. node
    tooltip or description, for reducing the memory footprint.  

Throws an invalid argument exception if FileName is empty. Throws if environment
variables in FileName cannot be resolved.  

attention: The given file must be readable until the camera description file
    data has been released. The IsCameraDescriptionFileDataReleased() method can
    be used to check if releasing has been done.  
";

%feature("docstring") GENAPI_NAMESPACE::CNodeMapFactory::CNodeMapFactory "

Creates the node map factory and simply stores the pointer and the size of the
...
* `ContentType` :  
    Defines how the camera description file is stored, e.g. as zipped XML text.  
* `pData` :  
    The pointer to the camera description file data.  
* `DataSize` :  
    The size of the camera description file data.  
* `CacheUsage` :  
    Defines if and how to use the cache for preprocessed camera description
    files.  
* `SuppressStringsOnLoad` :  
...
Creates the node map factory and copies the provided camera description file
string.  

Parameters
----------
* `XmlData` :  
    The camera description file data as XML text. The provided text is copied.
    You can use the overloaded constructor accepting a buffer to avoid that.  
* `CacheUsage` :  
    Defines if and how to use the cache for preprocessed camera description
    files.  
* `SuppressStringsOnLoad` :  
...
----------
* `injectionData` :  
    A node map factory representing a camera description file to inject.  

The injected files are injected in the order they are added. InjectionData must
not be preprocessed. The IsPreprocessed() method can be used to check if
preprocessing has been done before. The cache usage of injection data is
ignored.  
";
...
Creates a node map from the preprocessed memory internal representation of the
camera description file(s).  

Preprocess() is automatically called if needed. The preprocess step can be
omitted by the factory depending on the cache mode setting when a cache file is
available, then the cache file is read and converted directly into a node map.
ReleaseCameraDescriptionFileData() is called if
...
ReleaseCameraDescriptionFileData() is called if
DoReleaseCameraDescriptionFileData is true. This method can be called multiple
times to create multiple instances of a node map. This method allows to provide
an external lock to avoid using too many locks in an application.  
...
%feature("docstring") GENAPI_NAMESPACE::CNodeMapRef "
...
%feature("docstring") GENAPI_NAMESPACE::CNodeMapRef::CNodeMapRef "
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_c_node_map_ref_t.xml


%feature("docstring") GENAPI_NAMESPACE::CNodeMapRefT "
...
%feature("docstring") GENAPI_NAMESPACE::CPointer "
...
%feature("docstring") GENAPI_NAMESPACE::CPortImpl::Read "
...
%feature("docstring") GENAPI_NAMESPACE::CPortWriteList "
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_c_reference_t.xml
...
%feature("docstring") GENAPI_NAMESPACE::CReferenceT::CReferenceT "
";

%feature("docstring") GENAPI_NAMESPACE::CReferenceT::SetReference "

sets the implementation to the reference  
";

// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_c_register_ref_t.xml


%feature("docstring") GENAPI_NAMESPACE::CRegisterRefT "
";

%feature("docstring") GENAPI_NAMESPACE::CRegisterRefT::Set "

Set the register's contents.  
";

%feature("docstring") GENAPI_NAMESPACE::CRegisterRefT::Get "
...
%feature("docstring") GENAPI_NAMESPACE::CRegisterSetHelper "
...
%feature("docstring") GENAPI_NAMESPACE::CSelectorRefT::GetSelectingFeatures "
...
%feature("docstring") GENAPI_NAMESPACE::CSelectorSet "
...
%feature("docstring") GENAPI_NAMESPACE::CStringRefT "
";

%feature("docstring") GENAPI_NAMESPACE::CStringRefT::SetValue "
...
%feature("docstring") GENAPI_NAMESPACE::CTestPortStruct "
...
%feature("docstring") GENAPI_NAMESPACE::CTestPortStruct::GetAccessMode "
...
%feature("docstring") GENAPI_NAMESPACE::DCAM_CHECKSUM "
";

// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_d_c_a_m___c_h_u_n_k___t_r_a_i_l_e_r.xml
...
%feature("docstring") GENAPI_NAMESPACE::double_autovector_t "
...
%feature("docstring") GENAPI_NAMESPACE::EAccessModeClass "
...
%feature("docstring") GENAPI_NAMESPACE::ECachingModeClass "
...
%feature("docstring") GENAPI_NAMESPACE::ECachingModeClass::FromString "

Converts a string to enum value.  
";

%feature("docstring") GENAPI_NAMESPACE::ECachingModeClass::ToString "
";
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_e_display_notation_class.xml


%feature("docstring") GENAPI_NAMESPACE::EDisplayNotationClass "
...
%feature("docstring") GENAPI_NAMESPACE::EDisplayNotationClass::FromString "

Converts a string to enum value.  
";

%feature("docstring") GENAPI_NAMESPACE::EDisplayNotationClass::ToString "
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_e_endianess_class.xml


%feature("docstring") GENAPI_NAMESPACE::EEndianessClass "
...
%feature("docstring") GENAPI_NAMESPACE::EGenApiSchemaVersionClass "
...
%feature("docstring") GENAPI_NAMESPACE::EGenApiSchemaVersionClass::FromString "

Converts a string to enum value.  
";

%feature("docstring") GENAPI_NAMESPACE::EGenApiSchemaVersionClass::ToString "
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_e_input_direction_class.xml


%feature("docstring") GENAPI_NAMESPACE::EInputDirectionClass "
...
%feature("docstring") GENAPI_NAMESPACE::EInputDirectionClass::FromString "

Converts a string to enum value.  
";

%feature("docstring") GENAPI_NAMESPACE::EInputDirectionClass::ToString "
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_e_name_space_class.xml


%feature("docstring") GENAPI_NAMESPACE::ENameSpaceClass "
...
%feature("docstring") GENAPI_NAMESPACE::ENameSpaceClass::FromString "

Converts a string to enum value.  
";

%feature("docstring") GENAPI_NAMESPACE::ENameSpaceClass::ToString "
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_e_representation_class.xml


%feature("docstring") GENAPI_NAMESPACE::ERepresentationClass "
...
%feature("docstring") GENAPI_NAMESPACE::ESignClass "
...
%feature("docstring") GENAPI_NAMESPACE::ESlopeClass "
...
%feature("docstring") GENAPI_NAMESPACE::ESlopeClass::FromString "

Converts a string to enum value.  
";

%feature("docstring") GENAPI_NAMESPACE::ESlopeClass::ToString "
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_e_standard_name_space_class.xml


%feature("docstring") GENAPI_NAMESPACE::EStandardNameSpaceClass "
...
%feature("docstring") GENAPI_NAMESPACE::EVisibilityClass "
...
%feature("docstring") GENAPI_NAMESPACE::EYesNoClass "
...
%feature("docstring") GENAPI_NAMESPACE::EYesNoClass::FromString "

Converts a string to enum value.  
";

%feature("docstring") GENAPI_NAMESPACE::EYesNoClass::ToString "
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_file_protocol_adapter.xml


%feature("docstring") GENAPI_NAMESPACE::FileProtocolAdapter "
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_function___node_callback.xml


%feature("docstring") GENAPI_NAMESPACE::Function_NodeCallback "
...
%feature("docstring") GENAPI_NAMESPACE::Function_NodeCallback::Function_NodeCallback "
...
%feature("docstring") GENAPI_NAMESPACE::GVCP_CHUNK_TRAILER "
...
// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_g_v_c_p___e_v_e_n_t___i_t_e_m.xml


%feature("docstring") GENAPI_NAMESPACE::GVCP_EVENT_ITEM "
...
// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_g_v_c_p___e_v_e_n_t___i_t_e_m___b_a_s_i_c.xml


%feature("docstring") GENAPI_NAMESPACE::GVCP_EVENT_ITEM_BASIC "
...
// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_g_v_c_p___e_v_e_n_t___i_t_e_m___e_x_t_e_n_d_e_d___i_d.xml


%feature("docstring") GENAPI_NAMESPACE::GVCP_EVENT_ITEM_EXTENDED_ID "
...
// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_g_v_c_p___e_v_e_n_t___r_e_q_u_e_s_t.xml


%feature("docstring") GENAPI_NAMESPACE::GVCP_EVENT_REQUEST "
...
// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_g_v_c_p___e_v_e_n_t___r_e_q_u_e_s_t___e_x_t_e_n_d_e_d___i_d.xml


%feature("docstring") GENAPI_NAMESPACE::GVCP_EVENT_REQUEST_EXTENDED_ID "
...
// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_g_v_c_p___e_v_e_n_t_d_a_t_a___r_e_q_u_e_s_t.xml


%feature("docstring") GENAPI_NAMESPACE::GVCP_EVENTDATA_REQUEST "
...
// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_g_v_c_p___e_v_e_n_t_d_a_t_a___r_e_q_u_e_s_t___e_x_t_e_n_d_e_d___i_d.xml


%feature("docstring") GENAPI_NAMESPACE::GVCP_EVENTDATA_REQUEST_EXTENDED_ID "
...
// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_g_v_c_p___r_e_q_u_e_s_t___h_e_a_d_e_r.xml


%feature("docstring") GENAPI_NAMESPACE::GVCP_REQUEST_HEADER "
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_i_dev_file_stream_base.xml


%feature("docstring") GENAPI_NAMESPACE::IDevFileStreamBase "
";
...
// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_i_dev_file_stream_buf.xml
...
%feature("docstring") GENAPI_NAMESPACE::int64_autovector_t "
...
%feature("docstring") GENAPI_NAMESPACE::int64_autovector_t::int64_autovector_t "
";
...
%feature("docstring") GENAPI_NAMESPACE::LockableObject::Lock "

A scopelevel Lock class. Automatically acquires the lock when created and
...
%feature("docstring") GENAPI_NAMESPACE::LockableObject "
...
%feature("docstring") GENAPI_NAMESPACE::LockableObject::GetLock "

Get a new lock.  
";

// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_member___node_callback.xml


%feature("docstring") GENAPI_NAMESPACE::Member_NodeCallback "
...
%feature("docstring") GENAPI_NAMESPACE::Member_NodeCallback::Member_NodeCallback "

Constructor.  
";

%feature("docstring") GENAPI_NAMESPACE::Member_NodeCallback::Destroy "

destroys the object  
";

// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_c_node_map_factory_1_1_node_statistics__t.xml


%feature("docstring") GENAPI_NAMESPACE::CNodeMapFactory::NodeStatistics_t "
";

// File: class_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_o_dev_file_stream_base.xml
...
%feature("docstring") GENAPI_NAMESPACE::ODevFileStreamBuf "
";
...
%feature("docstring") GENAPI_NAMESPACE::SingleChunkData_t "
";

// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_single_chunk_data_str__t.xml
...
%feature("docstring") GENAPI_NAMESPACE::U3V_CHUNK_TRAILER "
...
// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_u3_v___c_o_m_m_a_n_d___h_e_a_d_e_r.xml


%feature("docstring") GENAPI_NAMESPACE::U3V_COMMAND_HEADER "
...
// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_u3_v___e_v_e_n_t___d_a_t_a.xml


%feature("docstring") GENAPI_NAMESPACE::U3V_EVENT_DATA "
...
// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_u3_v___e_v_e_n_t___m_e_s_s_a_g_e.xml


%feature("docstring") GENAPI_NAMESPACE::U3V_EVENT_MESSAGE "
...
// File: struct_g_e_n_a_p_i___n_a_m_e_s_p_a_c_e_1_1_c_port_write_list_1_1_write_command__t.xml
...
// File: _counter_8h.xml

// File: _d_l_l_load_8h.xml

// File: _enum_classes_8h.xml
...
// File: _event_adapter_g_e_v_8h.xml

// File: _event_adapter_u3_v_8h.xml

// File: _event_port_8h.xml

// File: _filestream_8h.xml

// File: _gen_api_8h.xml

// File: _gen_api_dll_8h.xml

// File: _gen_api_linkage_8h.xml

// File: _gen_api_namespace_8h.xml

// File: _gen_api_version_8h.xml

// File: _i_base_8h.xml

// File: _i_boolean_8h.xml

// File: _i_category_8h.xml

// File: _i_chunk_port_8h.xml

// File: _i_command_8h.xml

// File: _i_destroy_8h.xml

// File: _i_device_info_8h.xml

// File: _i_enum_entry_8h.xml

// File: _i_enumeration_8h.xml

// File: _i_enumeration_t_8h.xml

// File: _i_float_8h.xml

// File: _i_integer_8h.xml

// File: _i_node_8h.xml

// File: _i_node_map_8h.xml

// File: _i_node_map_dyn_8h.xml

// File: _i_port_8h.xml

// File: _i_port_construct_8h.xml
...
// File: _i_selector_digit_8h.xml

// File: _i_string_8h.xml

// File: _i_user_data_8h.xml

// File: _i_value_8h.xml

// File: _node_callback_8h.xml

// File: _node_map_factory_8h.xml

// File: _node_map_ref_8h.xml

// File: _persistence_8h.xml

// File: _pointer_8h.xml
...
// File: _register_set_helper_8h.xml
...
// File: group___gen_api___public_utilities.xml
